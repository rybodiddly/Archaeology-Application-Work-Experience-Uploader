...
def upload_experience(session, dict, javax_faces_ViewState, counter):
	...
	payload = {
		...
		'applicationWEWorkSituationForm:numOfPrtcptDays': int(dict['participation']),
		'autoScroll': '0,1296.5',
...
def upload_supervisor(session, dict, javax_faces_ViewState, counter):
	...
	payload = {
		...
		'applicationWEFieldWorkForm:specify': '',
		...
		'applicationWEFieldWorkForm:numOfSupDays': int(dict['supervisor_participation']),
		'applicationWEFieldWorkForm:fieldworkRoleId': supervisor_role(dict['supervisor_experience']),
		'applicationWEFieldWorkForm:numOfPrtcptDays': int(dict['participation']),
		'autoScroll': '0,1018',
